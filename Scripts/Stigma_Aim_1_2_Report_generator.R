...
setCellValue(cells[["5.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["6.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_end_ip=='End' | raw_data_baseline_ni_arm_1$tbip_sc_age <18)))
setCellValue(cells[["7.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_below_age=='Yes' | raw_data_baseline_ni_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["8.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q17=='No')))
setCellValue(cells[["9.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q8=='No')))
setCellValue(cells[["10.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_language=='No')))
setCellValue(cells[["11.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q13=='No')))
setCellValue(cells[["12.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_existing=='Yes')))


#Enrolment
setCellValue(cells[["17.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["18.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes')))
setCellValue(cells[["19.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_fw_note=='No')))
setCellValue(cells[["20.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='No')))
setCellValue(cells[["21.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_refuse___1=='I\'m not interested')))
setCellValue(cells[["22.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_refuse___2=='I am enrolled in another study')))
setCellValue(cells[["23.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_refuse___3=='I do not have time')))
setCellValue(cells[["24.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_refuse___4=='I am tired')))
setCellValue(cells[["25.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_refuse___5=='Other')))


#Caregiver eligibility
setCellValue(cells[["30.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_below_age=='Yes' | raw_data_baseline_ni_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["31.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["32.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_below_age=='Yes')))
setCellValue(cells[["33.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_cgiver_permission=='Yes')))
setCellValue(cells[["34.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_cgiver_permission=='No')))


#Aim 1 - Participant groups Newly initiated & Aim 1- Study visits / Retention

setCellValue(cells[["41.11"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["41.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes')))
setCellValue(cells[["41.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes')))
...
setCellValue(cells[["43.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_cgiver_permission=='Yes')))

#Clinic screening rate
setCellValue(cells[["49.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.12"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_q5=='NU 12 Clinic')))

#Clinic eligible rate
setCellValue(cells[["49.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.13"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='NU 12 Clinic')))


#Clinic enrolled rate
setCellValue(cells[["49.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.14"]], nrow(subset(raw_data_baseline_ni_arm_1, raw_data_baseline_ni_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_ni_arm_1$tbip_sc_q5=='NU 12 Clinic')))

##Participant time
setCellValue(cells[["71.11"]], mean(raw_data_baseline_ni_arm_1$tbip_q3_duration, na.rm = TRUE))
setCellValue(cells[["72.11"]], median(raw_data_baseline_ni_arm_1$tbip_q3_duration, na.rm = TRUE))
setCellValue(cells[["73.11"]], names(sort(-table(raw_data_baseline_ni_arm_1$tbip_q3_duration)))[1])
...
setCellValue(cells[["5.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["6.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_end_ip=='End' | raw_data_baseline_ex_arm_1$tbip_sc_age <18)))
setCellValue(cells[["7.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_below_age=='Yes' | raw_data_baseline_ex_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["8.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q17=='No')))
setCellValue(cells[["9.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q8=='No')))
setCellValue(cells[["10.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_language=='No')))
setCellValue(cells[["11.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q13=='No')))
setCellValue(cells[["12.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_existing=='Yes')))


#Enrolment
setCellValue(cells[["17.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["18.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_consent_part=='Yes')))
setCellValue(cells[["19.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_fw_note=='No')))
setCellValue(cells[["20.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_consent_part=='No')))
setCellValue(cells[["21.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_refuse___1=='I\'m not interested')))
setCellValue(cells[["22.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_refuse___2=='I am enrolled in another study')))
setCellValue(cells[["23.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_refuse___3=='I do not have time')))
setCellValue(cells[["24.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_refuse___4=='I am tired')))
setCellValue(cells[["25.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_refuse___5=='Other')))


#Caregiver eligibility
setCellValue(cells[["30.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_below_age=='Yes' | raw_data_baseline_ex_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["31.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_below_age=='No')))
setCellValue(cells[["32.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_below_age=='Yes')))
setCellValue(cells[["33.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_cgiver_permission=='Yes')))
setCellValue(cells[["34.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_cgiver_permission=='No')))


#Aim 1 - Participant groups Newly initiated & Aim 1- Study visits / Retention

setCellValue(cells[["41.19"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_eligible=='Proceed')))
setCellValue(cells[["41.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_consent_part=='Yes')))
setCellValue(cells[["41.6"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_consent_part=='Yes')))
...
setCellValue(cells[["43.6"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_cgiver_permission=='Yes')))

#Clinic screening rate
setCellValue(cells[["49.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.20"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_q5=='NU 12 Clinic')))

#Clinic eligible rate
setCellValue(cells[["49.21"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_ex_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_ex_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.21"]], nrow(subset(raw_data_baseline_ex_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.21"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_eligible=='Proceed' & raw_data_baseline_arm_1$tbip_sc_q5=='NU 12 Clinic')))


#Clinic enrolled rate
setCellValue(cells[["49.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Empilweni Gompo CHC')))
setCellValue(cells[["50.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Pefferville Clinic')))
setCellValue(cells[["51.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Duncan Village CHC')))
setCellValue(cells[["52.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo C Jabavu Clinic')))
setCellValue(cells[["53.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Chris Hani Clinic')))
setCellValue(cells[["54.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Luyolo NU 9 Clinic')))
setCellValue(cells[["55.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Alphendale Clinic')))
setCellValue(cells[["56.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='John Dube Clinic')))
setCellValue(cells[["57.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Fezeka NU 3 Clinic')))
setCellValue(cells[["58.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo A Ndende Clinic')))
setCellValue(cells[["59.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Ndevana Clinic')))
setCellValue(cells[["60.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Philani NU 1 Clinic')))
setCellValue(cells[["61.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Aspiranza Clinic')))
setCellValue(cells[["62.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Ginsberg Clinic')))
setCellValue(cells[["63.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Zwelitsha Zone 5 Clinic')))
setCellValue(cells[["64.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Masakhane Clinic (Zwelitsha)')))
setCellValue(cells[["65.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='Gompo B Jwayi Clinic')))
setCellValue(cells[["66.22"]], nrow(subset(raw_data_baseline_arm_1, raw_data_baseline_arm_1$tbip_sc_consent_part=='Yes' & raw_data_baseline_arm_1$tbip_sc_q5=='NU 12 Clinic')))

##Participant time
setCellValue(cells[["71.19"]], mean(raw_data_baseline_arm_1$tbip_q3_duration, na.rm = TRUE))
setCellValue(cells[["72.19"]], median(raw_data_baseline_arm_1$tbip_q3_duration, na.rm = TRUE))
setCellValue(cells[["73.19"]], names(sort(-table(raw_data_baseline_arm_1$tbip_q3_duration)))[1])
...
setCellValue(cells[["31.8"]], nrow(subset(raw_data_hhci_info_arm_1, raw_data_hhci_info_arm_1$hhc_pt_return_clinic=='Yes')))
setCellValue(cells[["31.9"]], nrow(subset(raw_data_hhci_info_arm_1, raw_data_hhci_info_arm_1$tbr_smear_1=='Yes')))
...
setCellValue(cells[["63.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(hhc_days_since_referral<=30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["64.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(hhc_days_since_referral<=30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
...
setCellValue(cells[["75.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["76.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
setCellValue(cells[["77.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & hhc_pt_collect_sputum=='Yes'& is.na(tbr_smear_res_1))))
...
#Self report and Extracted Only after 30 days
#setCellValue(cells[["55.19"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(hhc_sc_verbal_consent=='Yes' & hhc_days_since_referral>30)))
setCellValue(cells[["68.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(hhc_pc_been_facility=='No' & hhc_days_since_referral>30 & hhc_pt_return_clinic=='No')))
...
#setCellValue(cells[["71.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes')))
setCellValue(cells[["73.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes' & hhc_pt_collect_sputum=='No')))
setCellValue(cells[["74.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes' & hhc_pt_collect_sputum=='Yes')))
setCellValue(cells[["75.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["76.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
setCellValue(cells[["77.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_collect_sputum=='Yes'& is.na(tbr_smear_res_1))))

setCellValue(cells[["78.23"]], nrow(raw_data_hhci_info_ni_arm_1 %>% dplyr::filter(hhc_days_since_referral>30 & ((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_pt_return_clinic=='No') | (hhc_pc_been_facility=='No' & hhc_pt_return_clinic=='Yes'))))
...
setCellValue(cells[["63.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(hhc_days_since_referral<=30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["64.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(hhc_days_since_referral<=30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
setCellValue(cells[["65.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(hhc_days_since_referral<=30 & hhc_pt_collect_sputum=='Yes' & is.na(hhc_pc_testing_outcome))))
...
setCellValue(cells[["75.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["76.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
setCellValue(cells[["77.32"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter(is.na(hhc_pc_been_facility) & hhc_days_since_referral>30 & hhc_pt_collect_sputum=='Yes'& is.na(tbr_smear_res_1))))
...
#setCellValue(cells[["71.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes')))
setCellValue(cells[["73.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes' & hhc_pt_collect_sputum=='No')))
setCellValue(cells[["74.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_return_clinic=='Yes' & hhc_pt_collect_sputum=='Yes')))
setCellValue(cells[["75.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & tbr_smear_res_1=='Negative')))
setCellValue(cells[["76.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & (tbr_smear_res_1=='1+' | tbr_smear_res_1=='2+' | tbr_smear_res_1=='3+'))))
setCellValue(cells[["77.35"]], nrow(raw_data_hhci_info_ex_arm_1 %>% dplyr::filter((hhc_pc_been_facility=='Yes, I remember the date' | hhc_pc_been_facility=='Yes, I don\'t remember the date') & hhc_days_since_referral>30 & hhc_pt_collect_sputum=='Yes'& is.na(tbr_smear_res_1))))
